...
public class UpdateInvitationCommandValidator : IValidator<UpdateInvitationCommand>
{
    public Result<bool, Error> Validate(UpdateInvitationCommand value)
    {
        var arg = () => value is null ? UpdateInvitationCommand.Errors.IsNull : Error.None;
        ...
        var responseStatus = () =>
            new Invitation.ResponseStatusSpecification().IsSatisfiedBy(
                InvitationResponseStatuses.FromString(value.ResponseStatus.GetType().Name))
                ? Error.None
